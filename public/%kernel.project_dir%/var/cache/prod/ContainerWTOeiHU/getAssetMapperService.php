...
class getAssetMapperService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 4), #[\Closure(name: 'asset_mapper', class: 'Symfony\\Component\\AssetMapper\\AssetMapper')] fn () => ($container->privates['asset_mapper'] ?? $container->load('getAssetMapperService'))), (\dirname(__DIR__, 6).'/assets/vendor')), (\dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'C:'.\DIRECTORY_SEPARATOR.'xampp'.\DIRECTORY_SEPARATOR.'htdocs'.\DIRECTORY_SEPARATOR.'bibprojtt'.\DIRECTORY_SEPARATOR.'var'.\DIRECTORY_SEPARATOR.'cache'.\DIRECTORY_SEPARATOR.'prod/asset_mapper'), false), ($container->privates['asset_mapper.compiled_asset_mapper_config_reader'] ??= new \Symfony\Component\AssetMapper\CompiledAssetMapperConfigReader((\dirname(__DIR__, 6).'/public/assets'))));
    }
}
